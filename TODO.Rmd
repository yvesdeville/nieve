...
- **[X except for exp1]** Make the quantile functions work correctly for
...
- **[Done for `dGPD2`]** Make sure that the density functions are zero
  (not `NA`) outside of the support.

- **[Done for `pGPD2`]** Make sure that the distribution functions are
