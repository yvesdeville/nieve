...
[ ] In `GEV.tex`, the expressions related to the log-likelihood (and
   especially those for the $2$-nd order devrivatives could be made 
   much simpler by using the quantities $W$, $T$ as defined in the 
...
[ ] When checking a Hessian , one can geta false negative ressult
  because the numerical Hessian is wrong (typically, contains NA).
